...
- (void)viewDidLoad {
    ...
    namearry=[[NSArray alloc]initWithObjects:@"打工者的基本权利是什么",@"什么是劳动合同",@"劳动合同定立.变更和履行的原则有哪些",@"打工者的基本权利是什么",@"打工者的基本权利是什么",@"打工者的基本权利是什么",@"打工者的基本权利是什么",@"打工者的基本权利是什么",@"乱收培训费怎么办",@"乱收培训费怎么办",@"乱收培训费怎么办", nil];
