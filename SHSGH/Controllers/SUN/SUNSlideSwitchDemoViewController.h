...
@interface SUNSlideSwitchDemoViewController : UIViewController<SUNSlideSwitchViewDelegate>
{
    ...
    SUNListViewController *_vc7;
    SUNListViewController *_vc8;
}
...
@property (nonatomic, strong) SUNListViewController *vc7;
@property (nonatomic, strong) SUNListViewController *vc8;
